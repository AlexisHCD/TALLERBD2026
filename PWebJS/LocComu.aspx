...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <%--
        Página de mantenimiento (CRUD) de Comunas.
        La vista muestra una tabla y un modal para crear/editar.
        La interacción (cargar grilla, abrir modal, guardar cambios) se hace con JavaScript (JS/LocComu.js)
        consumiendo WebMethods del code-behind.
    --%>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-2">
                                <%-- Botón para crear nuevo registro (lo maneja el JS). --%>
    ...
    <%--
        ...
        - Lógica de interacción con el backend (WebMethod)
    --%>
