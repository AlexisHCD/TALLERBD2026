...
namespace Presentacion.Cliente
{
    public partial class PCli_Con : Form
    {
        ...
        private void ButClien_Click(object sender, EventArgs e)
        {
            //// Obtener una referencia al formulario principal
            //PArriendo_Ing Arr_Ing = Application.OpenForms.OfType<PArriendo_Ing>().FirstOrDefault();

            //// Verificar si se encontró el formulario principal
            //if (Arr_Ing != null)
            //{
            //    Arr_Ing.TextICliente.Text = this.Grilla.CurrentRow.Cells[1].Value.ToString();
            //    Arr_Ing.TextNom.Text = this.Grilla.CurrentRow.Cells[2].Value.ToString();
            //    Arr_Ing.TextRut.Text = this.Grilla.CurrentRow.Cells[3].Value.ToString();
            //    Arr_Ing.TextCom.Text = this.Grilla.CurrentRow.Cells[5].Value.ToString();
            //    Arr_Ing.TextDirec.Text = this.Grilla.CurrentRow.Cells[6].Value.ToString();
            //    Arr_Ing.TextTel.Text = this.Grilla.CurrentRow.Cells[7].Value.ToString();
            //    Arr_Ing.TextGir.Text = this.Grilla.CurrentRow.Cells[9].Value.ToString();
            //    Arr_Ing.Camtab();
            //    // Acceder al TextBox principal y asignar el valor
            //    //formularioPrincipal.TxtDatos.Text = datoACargar;
            //}
